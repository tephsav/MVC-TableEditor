...
public class DeleteDialog {
    ...
    private JButton deleteButtonFIOStudent;
    private JButton deleteButtonFIOParent;
    private JButton deleteButtonParentExperience;
    private JButton deleteButtonParentAddress;

    public DeleteDialog(Controller controller, MainFrame mainFrame) {
        this.studentController = controller;
        this.mainFrame = mainFrame;
        dialog = new JDialog();
        dialog.setTitle("Удаление студента");
        ...
        deleteButtonFIOStudent = new JButton("ФИО студента");
        deleteButtonFIOParent = new JButton("ФИО родителя");
        deleteButtonParentExperience = new JButton("Стаж работы");
        deleteButtonParentAddress = new JButton("Место работы");
        ...
        box.add(deleteButtonFIOStudent);
        box.add(deleteButtonFIOParent);
        box.add(deleteButtonParentExperience);
        box.add(deleteButtonParentAddress);
        panel.add(box);
        dialog.add(panel);

        deleteButtonFIOStudent.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ...
                controller.removeFIOStudent(student);
        ...
        deleteButtonFIOParent.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Student student = new Student();
                ...
                controller.removeFIOParent(student);
                dialog.setVisible(false);
                mainFrame.update();
            }
        });
        ...
        deleteButtonParentExperience.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Student student = new Student();
                student.setParentExperience(jTextFieldPExperience.getText());

                controller.removeParentExperience(student);
                dialog.setVisible(false);
                mainFrame.update();
            }
        });
        ...
        deleteButtonParentAddress.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Student student = new Student();
                ...
                controller.removeParentAddress(student);
                dialog.setVisible(false);
                mainFrame.update();
            }
        });
